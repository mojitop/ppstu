...
<?php endif; ?>
		...
		// 设置页面中的信息
		$this->assign(array(
			'page_name' => '添加<?php echo $config['tableCnName']; ?>',
			'page_btn_name' => '<?php echo $config['tableCnName']; ?>列表',
...
<?php endif; ?>
		...
		// 设置页面中的信息
		$this->assign(array(
			'page_name' => '修改<?php echo $config['tableCnName']; ?>',
			'page_btn_name' => '<?php echo $config['tableCnName']; ?>列表',
			'page_btn_target' => U('lst'),
		));
		$this->display();
...
<?php endif; ?>
		...
		// 设置页面中的信息
		$this->assign(array(
			'page_name' => '<?php echo $config['tableCnName']; ?>列表',
			'page_btn_name' => '添加<?php echo $config['tableCnName']; ?>',
