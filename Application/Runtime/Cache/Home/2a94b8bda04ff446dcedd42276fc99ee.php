	...
	<div class="guide w1210 bc mt15">
		...
		<div class="guide_content fl">
			...
			<div class="guide_wrap">
				<!-- 疯狂抢购 start showImage($v1['mid_logo'])-->
				<div class="crazy">
					<ul>
                                                <?php foreach($goods1 as $k1 => $v1):?>
						<li>
							<dl>
                                                            <dt><a href="<?php echo U('goods?id='.$v1['id']);?>"> <?php showImage($v1['mid_logo']);?> </a></dt>
								<dd><a href="<?php echo U('goods?id='.$v1['id']);?>"><?php echo $v1['goods_name'];?></a></dd>
								<dd><span>售价：</span><strong> ￥<?php echo $v1['promote_price']?></strong></dd>
							</dl>
						</li>
				                <?php endforeach;?>
					</ul>	
				...
				<div class="guess none">
					<ul>
						<li>
							<dl>
								<dt><a href="<?php echo U('goods?id='.$v1['id']);?>"><img src="/Public/Home/images/guess1.jpg" alt="" /></a></dt>
								<dd><a href="<?php echo U('goods?id='.$v1['id']);?>">Thinkpad USB光电鼠标</a></dd>
								<dd><span>售价：</span><strong> ￥39.00</strong></dd>
							</dl>
						</li>
						<li>
							<dl>
								<dt><a href="<?php echo U('goods?id='.$v1['id']);?>"><img src="/Public/Home/images/guess2.jpg" alt="" /></a></dt>
								<dd><a href="<?php echo U('goods?id='.$v1['id']);?>">宜客莱（ECOLA）电脑散热器</a></dd>
								<dd><span>售价：</span><strong> ￥89.00</strong></dd>
							</dl>
						</li>
						<li>
							<dl>
								<dt><a href="<?php echo U('goods?id='.$v1['id']);?>"><img src="/Public/Home/images/guess3.jpg" alt="" /></a></dt>
								<dd><a href="<?php echo U('goods?id='.$v1['id']);?>">巴黎欧莱雅男士洁面膏 100ml</a></dd>
		...
		<div class="sidebar fl ml10">
			...
			<div class="sidebar_wrap">
				<dl class="first">
					<dt class="fl"><a href="<?php echo U('goods?id='.$v1['id']);?>"><img src="/Public/Home/images/viewsonic.jpg" alt="" /></a></dt>
				...
				<dl>
					<dt class="fr"><a href="<?php echo U('goods?id='.$v1['id']);?>"><img src="/Public/Home/images/samsung.jpg" alt="" /></a></dt>
	...
	<div class="floor1 floor w1210 bc mt10">
		...
		<div class="floor_left fl">
			...
			<div class="cate fl">
				...
				<div class="cate_wrap">
					<ul>
						<?php foreach ($v['subCat_floorN'] as $k1 => $v1): ?>
			...
			<div class="goodslist fl">
				<h2>
					<?php foreach ($v['subCat_floorY'] as $k1 => $v1): ?>
