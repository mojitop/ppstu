	...
	<div class="list w1210 bc mt10">
		...
		<div class="list_bd fl ml10 mt10">
			...
			<div style="clear:both;"></div>
                        ...
                        <div style='padding:5px;background-color:lightgrey;<?php if(count(I("get.")) == 1){echo "display:none;";}?>' id='search_condition' >
                            <p >当前筛选条件：</p>
                             <div >
			...
			<div class="filter mt10">
				<h2><a href="/index.php/Home/Search/cat_search">重置筛选条件</a> <strong>商品筛选</strong></h2>
				<div class="filter_wrap">
					<dl>
						<dt>品牌：</dt>
                                                ...
                                                <dd><a href="/index.php/Home/Search/cat_search/cat_id/16/<?php echo $brand_name;?>"><?php echo $v['brand_name'];?></a></dd>
						<?php endforeach;?>
					</dl>
					...
					<dl>
						...
						<dd><a href="/index.php/Home/Search/cat_search/cat_id/16/<?php echo $price_name;?>"><?php echo $v;?></a></dd>
						<?php endforeach;?>
					</dl>
                                        <!-------属性筛选------>
					...
					<dl>    
						...
						<dt><?php echo $k;?>：</dt>   
                                                ...
                                                <dd><a href="/index.php/Home/Search/cat_search/cat_id/16/<?php echo 'attr_'.$v1['attr_id'].'/'.$k.'_'.$v1['attr_value'];?>"><?php echo $v1['attr_value'];?></a></dd>
						<?php endforeach;?>
