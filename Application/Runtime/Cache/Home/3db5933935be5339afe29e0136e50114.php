	...
	<div class="main w1210 bc mt10">
		...
		<div class="content fl ml10">
			<div class="order_hd">
				...
				<dl>
					<dt>便利提醒：</dt>
					<dd>待付款（<?php echo count($no_pay);?>）</dd>
					<dd>待确认收货（0）</dd>
					<dd>待自提（0）</dd>
				</dl>
				...
				<table class="orders">
					...
					<tbody>
						...
						<tr>
							...
							<td><a href="#">
                                                                <?php  $img = explode(',',$v['group_concat(c.sm_logo)']); if(!$img){ showImage($v['group_concat(c.sm_logo)']); }else{ foreach($img as $k1 => $v1){ showImage($v1); } } ?>
                                                            </a></td>
							...
							<?php endif; ?>
                                                        ...
                                                        <td><a href="<?php echo U('Index/goods?id='.$v['goods_id']);?>">查看</a> | <a href="#">删除</a></td>
						</tr>
                                                <?php endforeach;?>
					</tbody> 
