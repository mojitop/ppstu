...
<script type="text/javascript" src="/Public/Home/js/cart2.js"></script>
	...
	<div class="fillin w990 bc mt15">
		...
		<div class="fillin_bd">
				...
				<div class="address_select none">
					<ul>
						...
						<li><input type="radio" name="address" class="new_address"  />使用新地址</li>
                                    ...
                                    <form action="<?php echo U('order');?>" method='post' class="none" name="address_form">
						<ul>
							<li>
			...
			<div class="receipt">
				...
				<div class="receipt_select none">
					<form action="/index.php/Home/Cart/order.html">
						<ul>
							<li>
			...
			<div class="goods">
				...
				<table>
					...
					<tbody>
                                            <?php  $totle =0; foreach($cartData as $k => $v):?>
                                                <tr>
                                                        <td class="col1" ><a href=""><?php showImage($v['mid_logo']);?></a>  <strong>
                                                        ...
                                                        <td class="col3">￥<span><?php echo $v['goods_pri'];?></span></td>
                                                        <td class="col4"> 
                                                            <?php echo $v['goods_number'];?> 
                                                        </td>
                                                        <td class="col5">￥<span><?php echo $v['goods_pri']*$v['goods_number'];$totle +=$v['goods_pri']*$v['goods_number'];?></span></td>
                                                </tr>
                                            <?php endforeach;?>
					</tbody>
					<tfoot>
		...
		<div class="fillin_ft">
			...
			<p>应付总额：<strong>￥<?php echo $totle;?>元</strong></p>
