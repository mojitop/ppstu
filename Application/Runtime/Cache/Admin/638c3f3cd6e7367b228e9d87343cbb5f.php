...
<head>
<titlMGSHOP 管理中心 -<?php echo $page_name ;?>  </title>
...
<div class="form-div">
    <form action="/Index.php/Admin/Goods/LST" name="searchForm" method="get">
        ...
        商品名称：<input value="<?php echo I('get.gn');?>" type="text" name='gn'/>
        ...
        添加时间：从<input  type="text" id="LT" name='lt' value="<?php echo I('get.lt');?>" />
                 到<input  type="text" id="GT" name='gt'value="<?php echo I('get.gt');?>" /><br />
        <?php $odby = I('get.odby')?>
    ...
    <div class="list-div" id="listDiv">
        <table cellpadding="3" cellspacing="1">
            ...
            <tr class="tron">
                ...
                <td align="center"><span onclick=""><img src="/Public/Uploads/<?php echo $val['sm_logo'];?>" /></span></td>
